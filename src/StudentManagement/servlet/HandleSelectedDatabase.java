...
public class HandleSelectedDatabase extends HttpServlet {
    int fieldCount;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(boo){
            ...
            try {
                ...
                String condition = "SELECT * FROM "+tableName+ " WHERE "+fieldName+" LIKE '%"+require+"%'";
            ...
            catch (SQLException exp){System.out.print(exp);}
        }
